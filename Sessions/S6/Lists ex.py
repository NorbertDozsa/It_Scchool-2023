...
print("Temperaturile cele mai mici sunt:", temperaturi[0], temperaturi[1])

temperaturi.sort(reverse=True)

print("Temperaturile cele mai mari:", temperaturi[0], temperaturi[1])
